...
saveRDS(stan_data, here(paste0("data/processed/results/stan/stan_data_", PRIOR_TYPE, "_sensitivity.rds")))
...
saveRDS(
  ...
  here("data/processed/results/stan/design_matrices_sensitivity.rds")
)
...
saveRDS(
  ...
  here("data/processed/results/stan/index_keys_sensitivity.rds")
)
...
for (i in species_to_run) {
  ...
  save_path <- file.path(output_dir, paste0(spp, "_stanfit_", PRIOR_TYPE, "_sensitivity.rds"))
